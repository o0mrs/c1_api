...
declare class Hop {
    ...
    readonly projects: {
        ...
        secrets: {
            ...
            delete(id: `secret_${string}`, projectId?: `project_${string}` | undefined): Promise<void>;
        };
    };
    readonly pipe: {
        rooms: {
    ...
    readonly channels: {
        create(type: ChannelType, id?: string | null | undefined, options?: {
            state?: Record<string, any> | undefined;
        } | null | undefined, project?: `project_${string}` | undefined): Promise<Channel & {
            setState<T extends State>(state: SetStateAction<T>): Promise<void>;
            patchState<T_1 extends State>(state: SetStateAction<T_1>): Promise<void>;
        ...
        setState<T_2 extends State = State>(channel: string | Channel, state: SetStateAction<T_2>): Promise<void>;
        patchState<T_3 extends State>(channel: string | Channel, state: SetStateAction<T_3>): Promise<void>;
        publishMessage(channel: string | Channel, name: string, data: unknown): Promise<void>;
        tokens: {
